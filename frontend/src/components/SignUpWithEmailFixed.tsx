// This is a fixed version of the signUpWithEmail function that uses the useFirestoreWrite hook
// Copy this function into AppContext.tsx to replace the existing signUpWithEmail function
